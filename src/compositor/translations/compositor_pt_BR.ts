...
on how to implement it.
        ...
        <translation>A variável do ambiente XDG_RUNTIME_DIR não está definida.
Consulte sua distribuição sobre como obtê-la ou leia
http://www.freedesktop.org/wiki/Specifications/basedir-spec
...
It must also be owned by the current user (UID %3), but is owned by UID %4 (&quot;%5&quot;).
        ...
        <translation>XDG_RUNTIME_DIR está definido como &quot;%1&quot; e não está configurado corretamente.
O modo de acesso Unix deve ser 0700, mas está 0%2.
Também deve pertencer ao usuário atual (UID %3), mas pertence ao UID %4 (&quot;%5&quot;).
</translation>
    </message>
</context>
<context>
